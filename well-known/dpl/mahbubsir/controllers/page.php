...
//echo $this->email->print_debugger();
		...
		public function newslist()
	{
			 ...
			 $this->data['newslist'] =  $this->SiteModel->getlist('news', '*', array('IsActive'=>1), 'NewsID DESC', 20, 0); 
	 
		  
              
           $this->data['title'] = "News & Event | ". $this->data['siteinfo']["SiteName"];
		 
		   $this->data['description'] = "News & Event | ". $this->data['siteinfo']["SiteName"];
 	...
 	public function video()
	{
		   ...
		   $this->data['videolist'] =  $this->SiteModel->getlist('video', '*', array('IsActive'=>1), 'VideoID DESC', 20, 0); 
	 
              
           $this->data['title'] = "Video | ". $this->data['siteinfo']["SiteName"];
		 
		   $this->data['description'] = "Video| ". $this->data['siteinfo']["SiteName"];
	...
	public function project($id)
	{
		 ...
		 $this->data['projectlist'] =  $this->SiteModel->getlist('project', '*', array('IsActive'=>1,'ProjectID !='=>$id), 'ProjectID DESC', 4, 0); 
