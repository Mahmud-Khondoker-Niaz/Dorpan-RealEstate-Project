  <!-- End Site Header --><!-- Site Showcase -->
		 <!-- End Site Header --><!-- Site Showcase -->
							...
							<!-- Start Page Header -->
							<div class="parallax page-header" style="background-image:url();">
								<div class="container">
									<div class="row">
										<div class="col-md-12">
											<h1><?php echo $enterpriseinfo["EnterpriseName"];?></h1>
										</div>
								   </div>
							   </div>
							</div>
 ...
 <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title"> <?php echo $enterpriseinfo["EnterpriseName"];?></h2>
            </header>
            <article class="post-content">
                  <div class="post-meta meta-data">
                      <span><i class="fa fa-calendar"></i>  <?php echo date("dS M,Y");?></span>
                       
                    
                    
                </div>
               
               <?php echo $enterpriseinfo["Detail"];?>
            </article>
