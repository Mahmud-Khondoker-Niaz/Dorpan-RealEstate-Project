...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/user/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;">Complete your registration...</a></b></big><br />
<br />
