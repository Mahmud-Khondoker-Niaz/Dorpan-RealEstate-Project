...
<!-- BEGIN CONTENT -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Menu Entry
							</div>
							<div class="tools">
 ...
 $LinkType1 = array(   
	'name'	=> 'LinkType',
	'value'	=> 'InternalLink',
	'checked'     => ($LinkType == 'InternalLink') ? TRUE : FALSE 
 ...
 $LinkType2 = array(   
	...
	'value'	=> 'ExternalLink',
	'checked'     => ($LinkType == 'ExternalLink') ? TRUE : FALSE,
);
...
echo  form_hidden('MenuID',$MenuID);    echo  form_hidden('MenuGroup',$MenuGroup);  
 ?>  
								...
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											 ...
											 <?php echo form_dropdown($menu['name'], $menu['list'], $menu['selected'], 'id="form_2_select2" class="form-control select2me"'); ?>
				...
				<div class="form-group">
                                  ...
                                  <div class="form-group">
										<label class="control-label col-md-3">MenuLink
										<span class="required">
											 *
										</span>
										</label>
                                        ...
                                        <?php echo form_input($MenuLink); ?>
											 
                                             <span style="color: red;"><?php echo strip_tags(form_error($MenuLink['name'])); ?> </span> 
											<span class="help-block">
												 Write Link
											</span>
										</div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-list">
											...
											<?php echo form_radio($LinkType1); ?> Internal
                                            </label>
											<label class="radio-inline">
											<?php echo form_radio($LinkType2); ?> External </label>
										</div>
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										...
										<?php echo anchor("menu/".$nestedsubmenu, "Cancel", array("class"=>"btn default"));?> 
