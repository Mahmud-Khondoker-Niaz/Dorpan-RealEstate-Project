		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Menu Section <small>Entry</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
						 
                         <div class="actions">
								<a href="<?php echo site_url("menusection");?>" class="btn default yellow-stripe">
						...
						<li>
							<a href="<?php echo site_url("menusection");?>">
								Menu Section List
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Menu Section Entry
							</div>
							<div class="tools">
...
<?php echo form_open_multipart($this->uri->uri_string(),array("id"=>"form_sample_1","class"=>"form-horizontal"));    echo  form_hidden('MenuSectionID',$MenuSectionID);  
 ?>  
				...
				<div class="form-group">
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										...
										<?php echo anchor("menusection", "Cancel", array("class"=>"btn default"));?> 
