		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Video <small>Entry</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
						 
                         <div class="actions">
								<a href="<?php echo site_url("video");?>" class="btn default yellow-stripe">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Video Entry
							</div>
							<div class="tools">
...
echo  form_hidden('VideoID',$VideoID);     
 ?>  
				...
				<div class="form-group">
                                        ...
                                        <?php echo form_input($VideoName); ?>
											 
                                             <span style="color: red;"><?php echo strip_tags(form_error($VideoName['name'])); ?> </span> 
				             ...
				             <div class="form-group">
										<label class="control-label col-md-2">EmbeddedCode
										 <span class="required">
											 *
										</span>
										</label>
                                        ...
                                        <?php echo form_textarea($EmbeddedCode); ?>
											 
                                             <span style="color: red;"><?php echo strip_tags(form_error($EmbeddedCode['name'])); ?> </span>  
										</div>
									</div>				 
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										...
										<?php echo anchor("video", "Cancel", array("class"=>"btn default"));?> 
