   ...
   <div id="content">
	...
	<?php } ?>*/
        ...
        $(document).ready(function () {
		    ...
		    var data = new Array();
					  ...
					  var icount=0;
					  $.get('<?php echo base_url();?>basicsetup/arealist', function(data12) {													
			  
			
					 $.each(data12, function(key, val) {
			 
						 
			            data[icount] =  {'ID':val.AreaID, 'Delete':val.AreaID, 'AreaName':val.AreaName, 'Priority':val.Priority, 'titleofcourtesy':'ggg', 'birthdate':'123', 'hiredate':'f76', 'address':'www',  'Active':(val.IsActive==1)?"Yes":"No", 'last_login':'2012-11-12','created':'ddd','notes':'Notes Here'} ;
		   ...
		   var dbutton = function (row, datafield, value) {
			   //alert(value);
                 ...
                 return '<div style="margin:6px 10px;  width:70px; height:23px;" class="jqx-rc-all jqx-button jqx-widget jqx-fill-state-normal"><a   onClick="return confirm(\'Are you sure?\')" href="<?php echo base_url();?>basicsetup/areadelete/'+value+'"     style="height:23px; line-height:23px; color:#000;" >Delete</a></div>';
            }
            ...
            var source =
            {
				...
				deleterow: function (rowid, commit) {
									   ...
									   var flag = '';
										$("#indicator").css('display','block');
											$.ajax({
																		dataType: 'html',
																		type: 'post',
																		url: '<?php echo base_url();?>basicsetup/areadeleterow',
																		data: datarow,
			      ...
			      updaterow: function (rowid, rowdata, commit) {
                    ...
                    var datarow = "update=1&AreaName=" + rowdata.AreaName + '&priority='+priority_item+'&activated='+active_item;
				 ...
				 // $("#indicator").fadeIn(200).html('<img src="http://localhost/bdblog/siteimages/ajax-loader.gif" />');
				   $("#indicator").css('display','block');
				    $.ajax({
                        dataType: 'html',
						type: 'post',
                       	url: '<?php echo base_url();?>basicsetup/updatearearow',
                        data: datarow,
            ...
            var initrowdetails = function (index, parentElement, gridElement, datarecord) {
                ...
                if (tabsdiv != null) {
                   ...
                   // title.text(datarecord.ID);
                    ...
                    var AreaName = "<div style='margin: 10px;'><b>  Area Name:</b> " + datarecord.AreaName + "</div>";
               ...
               //  height: 500,
				...
				renderstatusbar: function (statusbar) {
				   ...
				   container2.append(addButton);
                    ...
                    addButton.click(function (event) {
                         window.location = '<?php echo base_url();?>basicsetup/areaentry';
				...
				// try to add modal yes no 
                    ...
                    refreshbutton.click(function (event) {
										  ...
										  var icount1=0;
										  $.get('<?php echo base_url();?>basicsetup/arealist', function(data122) {													
										 ...
										 $.each(data122, function(key, val) {
											...
											data2[icount1] =  {'ID':val.AreaID, 'Delete':val.AreaID, 'AreaName':val.AreaName, 'Priority':val.Priority, 'titleofcourtesy':'ggg', 'birthdate':'123', 'hiredate':'f76', 'address':'www',  'Active':(val.IsActive==1)?"Yes":"No",  'created':'ddd','notes':'Notes Here'} ;
                ...
                columns: [
                      ...
                      { text: 'Area', columntype: 'textbox',  datafield: 'AreaName', width: 100 },
    ...
    <script type="text/javascript">
            var buttonclick = function (id) {
				...
				window.location = '<?php echo base_url();?>basicsetup/areaentry/'+buttonID;
			    //alert(buttonID);
            }
			...
			var dbuttonclick = function (id) {
				...
				window.location = '<?php echo base_url();?>basicsetup/areadelete/'+buttonID;
			    //alert(buttonID);
            }
