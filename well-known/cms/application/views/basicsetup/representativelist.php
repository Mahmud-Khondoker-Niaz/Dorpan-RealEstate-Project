  ...
  <div id="bottombg"> 
   <div id="content">
	...
	/* var data = new Array();
	<?php for($i=0;$i<=10;$i++) {?>
	data[<?php echo $i;?>] =   {'firstname':'lokman', 'lastname':'hossain', 'title':'g', 'Contact':'ggg', 'birthdate':'123', 'hiredate':'f76', 'address':'www', 'city':'wewew', 'postalcode':'4343', 'country':'Bangladesh','homephone':'755','notes':'445454'} ;
	<?php } ?>*/
        ...
        $(document).ready(function () {
		    ...
		    var data = new Array();
					  ...
					  var icount=0;
					  $.get('<?php echo base_url();?>basicsetup/representativelist', function(data12) {													
			  
			
					 $.each(data12, function(key, val) {
			 
						 
			            data[icount] =  {'ID':val.RepresentativeID, 'Delete':val.RepresentativeID, 'RepresentativeName':val.RepresentativeName, 'Priority':val.Priority, 'Email':val.Email,  'Contact':val.ContactNumber, 'birthdate':'123', 'hiredate':'f76', 'address':'www',  'Active':(val.IsActive==1)?"Yes":"No", 'last_login':'2012-11-12','Thumbimage':val.Thumbimage,'notes':'Notes Here'} ;
		   ...
		   var dbutton = function (row, datafield, value) {
			   //alert(value);
                 ...
                 return '<div style="margin:6px 10px;  width:70px; height:23px;" class="jqx-rc-all jqx-button jqx-widget jqx-fill-state-normal"><a   onClick="return confirm(\'Are you sure?\')" href="<?php echo base_url();?>basicsetup/representativedelete/'+value+'"     style="height:23px; line-height:23px; color:#000;" >Delete</a></div>';
            }
            ...
            var source =
            {
				...
				deleterow: function (rowid, commit) {
									   ...
									   var flag = '';
										$("#indicator").css('display','block');
											$.ajax({
																		dataType: 'html',
																		type: 'post',
																		url: '<?php echo base_url();?>basicsetup/representativedeleterow',
																		data: datarow,
			      ...
			      updaterow: function (rowid, rowdata, commit) {
                    ...
                    var datarow = "update=1&RepresentativeName=" + rowdata.RepresentativeName + '&priority='+priority_item+'&activated='+active_item;
                    datarow = datarow +"&contact="+ rowdata.Contact+ "&Item_ID=" + rowdata.ID;
				 ...
				 // $("#indicator").fadeIn(200).html('<img src="http://localhost/bdblog/siteimages/ajax-loader.gif" />');
				   $("#indicator").css('display','block');
				    $.ajax({
                        dataType: 'html',
						type: 'post',
                       	url: '<?php echo base_url();?>basicsetup/updaterepresentativerow',
                        data: datarow,
            ...
            var initrowdetails = function (index, parentElement, gridElement, datarecord) {
                ...
                if (tabsdiv != null) {
                   ...
                   // title.text(datarecord.ID);
                    ...
                    var imgurl = '<?php echo base_url();?>/' + datarecord.Thumbimage;
                    ...
                    var RepresentativeName = "<div style='margin: 10px;'><b>Name:</b> " + datarecord.RepresentativeName + "</div>";
                    ...
                    $(leftcolumn).append(RepresentativeName);
                   ...
                   var Email = "<div style='margin: 10px;'><b>Email:</b> " + datarecord.Email + "</div>";
                    ...
                    var Contact = "<div style='margin: 10px;'><b>Hire Date:</b> " + datarecord.Contact + "</div>";
               ...
               //  height: 500,
				...
				renderstatusbar: function (statusbar) {
				   ...
				   container2.append(addButton);
                    ...
                    addButton.click(function (event) {
                         window.location = '<?php echo base_url();?>basicsetup/representativeentry';
				...
				// try to add modal yes no 
                    ...
                    refreshbutton.click(function (event) {
										  ...
										  var icount1=0;
										  $.get('<?php echo base_url();?>basicsetup/representativelist', function(data122) {													
										 ...
										 $.each(data122, function(key, val) {
										   ...
										   data2[icount1] =  {'ID':val.RepresentativeID, 'Delete':val.RepresentativeID, 'RepresentativeName':val.RepresentativeName, 'Priority':val.Priority, 'Email':val.Email,  'Contact':val.ContactNumber, 'birthdate':'123', 'hiredate':'f76', 'address':'www',  'Active':(val.IsActive==1)?"Yes":"No", 'last_login':'2012-11-12','Thumbimage':val.Thumbimage,'notes':'Notes Here'} ;
                ...
                {
                    return '<table style="height: 150px;"><tr><td><img src="<?php echo base_url();?>' + row.Thumbimage + '"/></td></tr><tr><td>' + row.RepresentativeName + '</td></tr></table>';
                },
                ...
                columns: [
                      ...
                      { text: 'Name', columntype: 'textbox',  datafield: 'RepresentativeName', width: 150 },
					  { text: 'Image', filterable: false ,  sortable: false, cellsalign:'center', editable: false, datafield: 'Thumbimage', width: 60, cellsrenderer: imagerenderer},
					  { text: 'Contact', columntype: 'textbox',  datafield: 'Contact', width: 180},
					  { text: 'Email', columntype: 'textbox',  datafield: 'Email', width: 180,  editable: false  },
		...
		/*	 $("#deleterowbutton").jqxButton({ theme: theme });
            ...
            $("#dropdownlist").jqxDropDownList({ autoDropDownHeight: true, selectedIndex: 0, width: 200, height: 23, theme: theme,
                source: [
                    'Representative', 'Contact', 'Email',  'Priority',   'Active?'
                ]
            });
    ...
    <script type="text/javascript">
            var buttonclick = function (id) {
				...
				window.location = '<?php echo base_url();?>basicsetup/representativeentry/'+buttonID;
			    //alert(buttonID);
            }
			...
			var dbuttonclick = function (id) {
				...
				window.location = '<?php echo base_url();?>basicsetup/representativedelete/'+buttonID;
			    //alert(buttonID);
            }
