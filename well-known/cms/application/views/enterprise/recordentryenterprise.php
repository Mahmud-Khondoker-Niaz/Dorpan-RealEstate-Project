		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Enterprise <small>Entry</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
						 
                         <div class="actions">
								<a href="<?php echo site_url("enterprise");?>" class="btn default yellow-stripe">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Enterprise Entry
							</div>
							<div class="tools">
...
echo  form_hidden('EnterpriseID',$EnterpriseID);     
 ?>  
				...
				<div class="form-group">
										<label class="control-label col-md-3">Enterprise
										<span class="required">
											 *
										</span>
										</label>
                                        ...
                                        <?php echo form_input($EnterpriseName); ?>
                                             ...
                                             <span style="color: red;"><?php echo strip_tags(form_error($EnterpriseName['name'])); ?> </span> 
				            ...
				            <div class="form-group">
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										...
										<?php echo anchor("enterprise", "Cancel", array("class"=>"btn default"));?> 
