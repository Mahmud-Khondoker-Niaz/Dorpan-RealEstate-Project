				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
                         ...
                         <div class="actions">
								<a href="<?php echo site_url("news/newsentry");?>" class="btn default yellow-stripe">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<table class="table table-striped table-bordered table-hover" id="datatable_ajax" data-url="<?php echo site_url("news/getlist");?>">
								<thead>
								<tr role="row" class="heading"> 
 								...
 								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="NewsTitle">
									</td>
