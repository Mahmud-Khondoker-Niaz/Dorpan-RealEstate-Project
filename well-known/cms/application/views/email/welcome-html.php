...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/siteadmin/login/'); ?>" style="color: #3366cc;">Go to <?php echo $site_name; ?> now!</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?php echo site_url('/siteadmin/login/'); ?>" style="color: #3366cc;"><?php echo site_url('/siteadmin/login/'); ?></a></nobr><br />
<br />
<br />
