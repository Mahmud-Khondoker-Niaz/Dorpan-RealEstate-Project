			...
			<!-- BEGIN PAGE HEADER-->
			 <div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Management <small>List</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
						 
                         <div class="actions">
								<a href="<?php echo site_url("writer/writerentry");?>" class="btn default yellow-stripe">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<table class="table table-striped table-bordered table-hover" id="datatable_ajax"  data-url="<?php echo site_url("writer/getlist");?>">
								<thead>
								<tr role="row" class="heading">
 								...
 								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="WriterID">
									</td>
									 
									<td>
										<input type="text" class="form-control form-filter input-sm" name="WriterName">
									</td>
									...
									<td>
										<select name="IsActive" class="form-control form-filter input-sm">
                                            ...
                                            <option value="1">Columnist</option> 
